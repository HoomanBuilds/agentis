...
const demos = [
  { title: 'Mint Agent NFT', description: 'Define a personality, upload an avatar, pay 10 STRK — you own it.', Illustration: LiveChatIllustration },
  { title: 'Chat with Any Agent', description: 'Purchase credits and start intelligent conversations instantly.', Illustration: TicketResolutionIllustration },
  { title: 'Trade on Marketplace', description: 'List your agent for sale and earn from every future session.', Illustration: MultiChannelIllustration },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-display mb-4">
            See <span className="text-gradient-lime">Agentis</span> in action
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">
            From minting to chatting to earning — all on Starknet
          </p>
        </motion.div>
