...
const footerLinks = {
  ...
  Account: [
    ...
    { label: "Credits", href: "/profile" },
  ],
  Starknet: [
    { label: "Voyager Explorer", href: "https://sepolia.voyager.online" },
    { label: "Starknet Docs", href: "https://docs.starknet.io" },
  ],
}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">AI agent NFTs on Starknet.</p>
          </div>
        ...
        <div className="mt-8 sm:mt-12 pt-4 sm:pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] sm:text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Agentis. All rights reserved.
          </p>
